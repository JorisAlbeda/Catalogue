...
A brisk, scale-quick trader who ran the stalls at Tinker's Fair since Ede Oswick, Perrine's own mother, first showed her how to balance a scale honestly decades back. Kept three different currencies sorted by ear before she'd even looked at them, and never quoted a price twice if the first one hadn't landed.
...
Deceased — old age, well after Openhold's own war had already passed into other people's stories.

## Voice

Vocabulary level: plain, transactional. Verbal habit: named an exact number before she'd discuss anything else ("Six. Now what did you want to say?"). Emotional default: brisk, unbothered. Speech rhythm: clipped, fast.
